...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  constructor() {
	    ...
	    // this.lightWeightSpaceshipAttack = true;
	  ...
	  placerandomObjectRandomly() {
	    ...
	    for (let i = 0; i < randTries; i++) {
	      ...
	      const placeHere = this.isAllDead([randX, randY], dist);
	      if (placeHere) {
	        this.placeObject([randX, randY], randomObjectName);
	        return null;
	      }
	    }
	  }
	...
	Square.OBJECTNAMES =
	  ...
	  "pulsar", "pentadecathlon", "glider", "lightWeightSpaceship", "clock"];
