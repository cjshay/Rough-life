...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  giveSquareLife(event) {
	    ...
	    this.context.fillStyle = this.squares[[xPos, yPos]].color;
	    this.context.fillRect(this.squares[[xPos, yPos]].canvasPosition[0], this.squares[[xPos, yPos]].canvasPosition[1], this.squares[[xPos, yPos]].width, this.squares[[xPos, yPos]].height);
	  }
