...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	  ...
	  squareClick() {
	    ...
	    // canvas.addEventListener("mousedown", this.enableDragLife.bind(this));
	    // canvas.addEventListener("mouseup", this.enableDragLife.bind(this));
	  }
	  ...
	  //     canvas.addEventListener("mousemove", this.giveSquareLife.bind(this));
	  //   } else {
	  //     canvas.removeEventListener("mousemove", this.doNothing);
	  //   }
	  // }
